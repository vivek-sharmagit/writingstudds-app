  ...
  return (
    <>
      ...
      <div className="home2">
        ...
        <div>
          <p>
             A random paragraph can also be
            an excellent way for a writer to tackle writers' block. Writing
            block can often happen due to being stuck with a current project
            that the writer is trying to complete. 
          </p>
        </div>
      </div>
      ...
      <div className="home4" id="collaboration">
        <div>
          <h1>Collaboration</h1>
